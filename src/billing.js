...
export const API_PRICES = Object.freeze({
  ...
  'clop-4-pulsar': { title: 'Clop 4 Pulsar', input: 2.5, cachedInput: .25, cacheWrite: 3.125, output: 12.5 },
  'clop-4-pro': { title: 'Clop 4 Pro', input: 4, cachedInput: .4, output: 20 },
  'clop-4-flash': { title: 'Clop 4 Flash', input: 2, cachedInput: .2, output: 12 },
