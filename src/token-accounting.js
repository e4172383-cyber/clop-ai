...
// Прежняя квота GPT ×2 дополнительно увеличена втрое: итог ×6. В общий пул
// попадает шестая часть расхода. Правило действует и для сохранённых событий.
export const GPT_LIMIT_BOOST = 6;
